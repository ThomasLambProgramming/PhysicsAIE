...
//collision detection functions for the different shapes.
...
//SOMEWHAT UNDERSTAND
//Read the comments for each thing below.
bool PhysicsScene::Sphere2Plane(PhysicsObject* objSphere, PhysicsObject* objPlane)
{
	...
	if (sphere != nullptr && plane != nullptr)
	{
		...
		//Distance from sphere to plane = CenterSphere Dot PlaneNormal - DistanceFromOrigin  
		//the dot of centerposition and planenormal gives the distance from origin from the sphere along the planes normal so when 
		...
		{
			//this formula below finds the contact point as it will be on the circumference that lies along the collision normal (tutorial answer)
...
//UNDERSTAND
//if distance from center to center is less than radius1 + radius2 then it has collided
bool PhysicsScene::Sphere2Sphere(PhysicsObject* obj1, PhysicsObject* obj2)
{
	...
	if (sphere1 != nullptr && sphere2 != nullptr)
	{
		...
		if (penetration > 0)
		{
			//getting the middle of the two spheres that is colliding
